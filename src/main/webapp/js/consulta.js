(function() {
  ...
  ConsultaTSE.UndefinedJob = (function(superClass) {
    ...
    UndefinedJob.prototype.showTurnInput = function() {
      return false;
    };
  ...
  ConsultaTSE.PresidenteJob = (function(superClass) {
    ...
    PresidenteJob.prototype.showTurnInput = function() {
      return true;
    };
  ...
  ConsultaTSE.VicePresidenteJob = (function(superClass) {
    ...
    VicePresidenteJob.prototype.showTurnInput = function() {
      return true;
    };
  ...
  ConsultaTSE.GovernadorJob = (function(superClass) {
    ...
    GovernadorJob.prototype.showTurnInput = function() {
      return true;
    };
  ...
  ConsultaTSE.ViceGovernadorJob = (function(superClass) {
    ...
    ViceGovernadorJob.prototype.showTurnInput = function() {
      return true;
    };
  ...
  ConsultaTSE.SenadorJob = (function(superClass) {
    ...
    SenadorJob.prototype.showTurnInput = function() {
      return false;
    };
  ...
  ConsultaTSE.DeputadoFederalJob = (function(superClass) {
    ...
    DeputadoFederalJob.prototype.showTurnInput = function() {
      return false;
    };
  ...
  ConsultaTSE.DeputadoEstadualJob = (function(superClass) {
    ...
    DeputadoEstadualJob.prototype.showTurnInput = function() {
      return false;
    };
  ...
  ConsultaTSE.DeputadoDistritalJob = (function(superClass) {
    ...
    DeputadoDistritalJob.prototype.showTurnInput = function() {
      return true;
    };
  ...
  ConsultaTSE.PrimeiroSuplenteSenadorJob = (function(superClass) {
    ...
    PrimeiroSuplenteSenadorJob.prototype.showTurnInput = function() {
      return false;
    };
  ...
  ConsultaTSE.SuplenteSenadorJob = (function(superClass) {
    ...
    SuplenteSenadorJob.prototype.showTurnInput = function() {
      return false;
    };
  ...
  ConsultaTSE.PrefeitoJob = (function(superClass) {
    ...
    PrefeitoJob.prototype.showTurnInput = function() {
      return true;
    };
  ...
  ConsultaTSE.VicePrefeitoJob = (function(superClass) {
    ...
    VicePrefeitoJob.prototype.showTurnInput = function() {
      return true;
    };
  ...
  ConsultaTSE.VereadorJob = (function(superClass) {
    ...
    VereadorJob.prototype.showTurnInput = function() {
      return false;
    };
...
(function() {
  ConsultaTSE.Query = (function() {
    ...
    Query.prototype.reset = function() {
      ...
      this.setTurn(1);
      return this.setFiltroRegional(0);
    };
...
(function() {
  ...
  ConsultaTSE.QueryView = (function(superClass) {
    ...
    QueryView.prototype.initializeComponents = function() {
      ...
      return this.resetBtn.click((function(_this) {
        return function(e) {
          return _this.onResetBtnClick(e);
        };
      })(this));
    };

    QueryView.prototype.onResetBtnClick = function(e) {
      e.preventDefault();
      this.query.reset();
      this.requiredFieldsFilter.reset();
      this.electionsFilter.disable();
      this.columnsFilter.disable();
      return this.optionalFilter.disable();
    };
...
(function() {
  ...
  ConsultaTSE.RequiredFieldsFilterView = (function(superClass) {
    ...
    RequiredFieldsFilterView.prototype.reset = function() {
      this.turn.val(0);
      this.job.val(0);
      this.regionalAggregation.val('');
      return this.politicalAggregationLevel.val('');
    };

    RequiredFieldsFilterView.prototype.updateTurnInput = function() {
      if (this.query.getJob() === null) {
        return this.turnContainer.hide('slow');
      } else {
        if (this.query.getPoliticalAggregationLevel() === 3 || !this.query.getJob().showTurnInput()) {
          return this.turnContainer.hide('slow');
        } else {
          return this.turnContainer.show('slow');
        }
      }
    };
...
(function() {
  ...
  ConsultaTSE.OptionalFiltersView = (function(superClass) {
    ...
    OptionalFiltersView.prototype.loadCandidatos = function() {
      if (this.query.getPoliticalAggregationLevel() === 2) {
        this.candidatosComponent.show('slow');
        return this.candidatosSuggestions.initialize(true);
      } else {
        return this.candidatosComponent.hide('slow');
      }
    };
